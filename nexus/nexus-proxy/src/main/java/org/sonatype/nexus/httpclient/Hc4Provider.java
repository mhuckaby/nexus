...
/**
 * Component for sharing and creating pre-configured Apache HttpClient4x instances in Nexus.
 * 
 * @author cstamas
 * @since 2.2
 */
public interface Hc4Provider
{
     ...
     * configuration changes, the client needs reconfiguration too, hence if you keep a reference to the created client,
     ...
     * 
     * @return the client to be used to execute HTTP requests.
     */
     ...
     * managed or shutdown!
     * 
     * @param context to source connection parameters from. Will it be used (and for what), depends on
     *            {@link Hc4Parameters} implementation too!
     * @return HTTP Client pre-configured instance, that uses passed in connection manager.
     */
